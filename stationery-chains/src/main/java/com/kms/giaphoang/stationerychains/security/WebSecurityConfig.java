...
public class WebSecurityConfig extends KeycloakWebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().and()
                ...
                .antMatchers(HttpMethod.POST, "/api/v1/orders/**").hasRole(ADMIN.name())
                .antMatchers(HttpMethod.PUT, "/api/v1/orders/**").hasRole(ADMIN.name())
                .antMatchers(HttpMethod.DELETE, "/api/v1/orders/**").hasRole(ADMIN.name())
                .antMatchers(HttpMethod.GET, "/api/v1/orders/**").hasAnyRole(ADMIN.name(), CUSTOMER.name())
